...
user1 = User.create(username: 'name1', password: 'pass1', pin: 0000)
...
# user6 = User.create(username: 'name6', password: 'pass6', pin: 5555)
# user7 = User.create(username: 'name7', password: 'pass7', pin: 6666)
# user8 = User.create(username: 'name8', password: 'pass8', pin: 7777)
# user9 = User.create(username: 'name9', password: 'pass9', pin: 8888)
# user10 = User.create(username: 'name10', password: 'pass10', pin: 9999)
# user11 = User.create(username: 'name11', password: 'pass11', pin: 0123)
# user12 = User.create(username: 'name12', password: 'pass12', pin: 0456)
# user13 = User.create(username: 'name13', password: 'pass13', pin: 0789)
# user14 = User.create(username: 'name14', password: 'pass14', pin: 1234)
# user15 = User.create(username: 'name15', password: 'pass15', pin: 1235)
